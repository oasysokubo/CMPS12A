...
public class Accountant extends Employee {
    ...
    private final double HEALTH_INSURANCE = 15000;      // $/year 
    private final double INCOME = 125000;               // $/year
    ...
    void usePaidVacation() {                            // adds one to usedVacation // instance variable.
        usedVacation++;
    }
